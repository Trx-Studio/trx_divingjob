...
function RentVehicle(vehicle, zoneIndex)
    ...
    if confirm == 'confirm' then
        TriggerServerEvent('MrJ-diving:server:RentVehicle', vehicle.name, duration, totalPrice, zoneIndex)
    end
end
...
RegisterNetEvent('MrJ-diving:client:SpawnRentedVehicle', function(vehicleName, zoneIndex)
